...
# Exercise-2 TODOs:
    ...
    no_noise_pub.publish(ros_cloud_filtered) 
...
if __name__ == '__main__':
    ...
    # Create Subscribers to depth camera 
    pcl_sub = rospy.Subscriber("/pr2/world/points", pc2.PointCloud2, pcl_callback, queue_size=1)

    # Create Publishers
    no_noise_pub = rospy.Publisher("/no_noise_pup", PointCloud2, queue_size=1)
